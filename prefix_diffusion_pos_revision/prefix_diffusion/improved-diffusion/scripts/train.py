...
def main():
    ...
    # model_dict = torch.load("/home/wjworkspace/prefix_diffusion_pos_revision/prefix_diffusion/improved-diffusion/diffusion_model/coco/1000_48_512_10bert+scm/ema_0.9999_200000.pt")
    ...
    if args.modality == 'image':
        ...
        next(data)
        posmodel, model2, tokenizer = load_models(args.modality, args.experiment, args.model_name_or_path, args.in_channel,
